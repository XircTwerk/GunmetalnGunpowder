package com.xirc.milicraft.common.entity.projectile;
...
public class BulletProjectile extends AbstractArrow {
    ...
    public BulletProjectile(Level world, LivingEntity owner, float caliber, float length, int stunTicks, float damage) {
        ...
        setSoundEvent(MilicraftSoundRegistry.BULLET_RICOCHET.get());
    }
        ...
        if (type == HitResult.Type.ENTITY) {
            ...
            if (impactAngleDeg > penAngle || lowEnergy) {
                ...
                if (lowEnergy || !through) {
                    ...
                    playServerSound(MilicraftSoundRegistry.BULLET_PENETRATE.get(), position());
                }
            } else {
                ...
                if (!level().isClientSide()) {
                    ...
                    playServerSound(MilicraftSoundRegistry.BULLET_RICOCHET.get(), position());
                }
            }
        }
    }
