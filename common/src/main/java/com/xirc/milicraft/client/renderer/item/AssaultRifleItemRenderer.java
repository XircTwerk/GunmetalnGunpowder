...
import com.xirc.milicraft.client.animation.AssaultRifleAnimator;
...
public class AssaultRifleItemRenderer extends AbstractGunItemRenderer {
    ...
    private static final ResourceLocation EFFECTS_TEXTURE = Milicraft.id("textures/assault_rifle/effects.png");
    ...
    public static AssaultRifleItemRenderer create() {
        return new AssaultRifleItemRenderer(
                Milicraft.id("geo/assault_rifle.geo.json"),
                Milicraft.id("textures/assault_rifle/default.png")
        );
    }
}
