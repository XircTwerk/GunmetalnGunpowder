package com.xirc.milicraft.client.aim;
...
public final class GunAimHandler {
    ...
    public static void tick(Minecraft minecraft) {
        ...
        if (shouldAim != aiming) {
            aiming = shouldAim;
            MilicraftKeyMappings.send(aiming
                    ? MilicraftPacketRegistry.GunInput.AIM_START
                    : MilicraftPacketRegistry.GunInput.AIM_STOP);
        }
