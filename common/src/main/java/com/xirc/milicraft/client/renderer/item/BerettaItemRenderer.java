...
import com.xirc.milicraft.client.animation.BerettaAnimator;
...
public class BerettaItemRenderer extends AbstractGunItemRenderer {
    ...
    private static final ResourceLocation EFFECTS_TEXTURE = Milicraft.id("textures/beretta/effects.png");
    ...
    public static BerettaItemRenderer create() {
        return new BerettaItemRenderer(
                Milicraft.id("geo/beretta.geo.json"),
                Milicraft.id("textures/beretta/default.png")
        );
    }
}
