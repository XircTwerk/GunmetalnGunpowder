package com.xirc.militech.client.outline;
 ...
 *
 * The loader-specific module registers the shader on RegisterShadersEvent (Forge) /
 * CoreShaderRegistrationCallback (Fabric) and calls {@link #setShader} once loaded. A
 * RenderType's shader state shard reads it back via {@link #getShader} every frame, and
 * uploads {@link #getCurrentWidth()} into the OutlineWidth uniform before each draw.
 */
