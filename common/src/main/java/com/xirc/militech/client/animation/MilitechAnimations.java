...
public final class MilitechAnimations {
    private static final ResourceLocation CONTROLLER_ID = Militech.id("animation_controller");
    ...
    private static AdjustmentModifier gunHoldModifier(AbstractClientPlayer player) {
        return new GunArmModifier(partName -> {
            ...
            float sideAim = SIDE_AIM.computeIfAbsent(player, MilitechAnimations::targetSideAim);
