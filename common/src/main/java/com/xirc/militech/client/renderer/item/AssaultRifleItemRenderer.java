...
import com.xirc.militech.client.animation.AssaultRifleAnimator;
...
public class AssaultRifleItemRenderer extends AbstractGunItemRenderer {
    ...
    private static final ResourceLocation EFFECTS_TEXTURE = Militech.id("textures/assault_rifle/effects.png");
    ...
    public static AssaultRifleItemRenderer create() {
        return new AssaultRifleItemRenderer(
                Militech.id("geo/assault_rifle.geo.json"),
                Militech.id("textures/assault_rifle/default.png")
        );
    }
}
