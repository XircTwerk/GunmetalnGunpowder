...
import com.xirc.militech.client.animation.BerettaAnimator;
...
public class BerettaItemRenderer extends AbstractGunItemRenderer {
    ...
    private static final ResourceLocation EFFECTS_TEXTURE = Militech.id("textures/beretta/effects.png");
    ...
    public static BerettaItemRenderer create() {
        return new BerettaItemRenderer(
                Militech.id("geo/beretta.geo.json"),
                Militech.id("textures/beretta/default.png")
        );
    }
}
