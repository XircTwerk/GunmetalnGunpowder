package com.xirc.militech.common.entity.projectile;
...
public class BulletProjectile extends AbstractArrow {
    ...
    public BulletProjectile(Level world, LivingEntity owner, float caliber, float length, int stunTicks, float damage) {
        ...
        setSoundEvent(MilitechSoundRegistry.BULLET_RICOCHET.get());
    }
        ...
        if (type == HitResult.Type.ENTITY) {
            ...
            if (impactAngleDeg > penAngle || lowEnergy) {
                ...
                if (lowEnergy || !through) {
                    ...
                    playServerSound(MilitechSoundRegistry.BULLET_PENETRATE.get(), position());
                }
            } else {
                ...
                if (!level().isClientSide()) {
                    ...
                    playServerSound(MilitechSoundRegistry.BULLET_RICOCHET.get(), position());
                }
            }
        }
    }
